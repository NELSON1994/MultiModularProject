...
public class TransportPackager extends ISOBasePackager {
    ...
    public TransportPackager() {
        ...
        ISOFieldPackager[] fld = {
                ...
                /*007*/ new IFB_NUMERIC(10, "Date and time, transmission", pad), //MMddhhmmss
                /*008*/ new IFB_NUMERIC(20, "Customer category", pad),
                /*009*/ new IFB_NUMERIC(9, "CONVERSION RATE, SETTLEMENT",pad),
                /*010*/ new IFB_NUMERIC(8, "Conversion rate, Cardholder billing", pad),
                /*011*/ new IFB_NUMERIC(6, "Systems trace audit number", pad),
                /*012*/ new IFB_NUMERIC(6, "Date and time, Local transaction", pad), //hhmmss
                /*013*/ new IFB_NUMERIC(4, "Date, Effective", pad), //mmdd
                /*014*/ new IFB_NUMERIC(4, "Date, Expiration", pad),//yymm
                /*015*/ new IFB_NUMERIC(6, "Date, Settlement", pad),//yyMMdd
                /*016*/ new IFB_NUMERIC(4, "Date, Conversion", pad),//MMdd
                /*017*/ new IFB_NUMERIC(4, "Date, Capture", pad), //MMdd
                ...
                /*022*/ new IFB_NUMERIC(3, "TPOINT OF SERVICE ENTRY MODE", pad), // =============was 15
                ...
                /*026*/ new IFB_NUMERIC(2, "POINT OF SERVICE PIN CAPTURE CODE", pad), //=========== was 4
                /*027*/ new IFB_NUMERIC(1, "AUTHORIZATION IDENTIFICATION RESP LEN", pad),
                /*028*/ new IFB_NUMERIC(9, "AMOUNT, TRANSACTION FEE", pad),//==============was 6
                /*029*/ new IFB_NUMERIC(3, "AMOUNT, SETTLEMENT FEE", pad),
                /*030*/ new IFB_NUMERIC(24, "AMOUNT, TRANSACTION PROCESSING FEE", pad),
                /*031*/ new IFB_LLLCHAR(999, "Acquirer reference data"),
                ...
                /*035*/ new IFB_LLNUM(37, "Track 2 data", pad),//====================was 40
                /*036*/ new IFB_LLLCHAR(104, "Track 3 data"),
                /*037*/ new IF_CHAR(12, "Retrieval reference number"),
                /*038*/ new IF_CHAR(6, "AUTHORIZATION IDENTIFICATION RESPONSE"), // ===was 99 IF_CHAR
                /*039*/ new IF_CHAR(2, "Response / action code"),
                /*040*/ new IFB_NUMERIC(3, "SERVICE RESTRICTION CODE", pad),
                ...
                /*045*/ new IFB_LLCHAR(75, "Track 1 data"),//==========================was 76
                /*046*/ new IFB_LLLCHAR(206, "Amounts, Fees"), //======================was 204
                /*047*/ new IFB_LLLCHAR(999, "Additional data - national"),// =======================LOG IN DATA
                ...
                /*053*/ new IFB_NUMERIC(16, "Security related control information",pad), // was 48 IFB_LLBINARY
                /*054*/ new IFB_LLLCHAR(120, "Amounts, additional"),
                /*055*/ new IFB_LLLBINARY(999, "IC card system related data"), // =====================was 999  to be 255
                /*056*/ new IFB_LLNUM(35, "Original data elements", pad),
                /*057*/ new IFB_NUMERIC(3, "Authorization life cycle code", pad),//============not in way 4
                /*058*/ new IFB_LLNUM(11, "Authorizing agent institution Id Code", pad),//===========not in way 4
                /*059*/ new IFB_LLLBINARY(999, "Transport data"),// was IFB_LLLCHAR 999
                /*060*/ new IFB_LLLCHAR(999, "Reserved for national use"),
                /*061*/ new IFB_LLLCHAR(999, "Reserved for national use"),// ===========NOT IN WAY 4
                /*062*/ new IFB_LLLCHAR(999, "Reserved for private use"),//=============was LLLBINARY
                /*063*/ new IFB_LLLCHAR(999, "Reserved for private use"),
                /*064*/ new IFB_BINARY(4, "Message authentication code field"),// ============was 8
